...
const Product = () => {
  ...
  // Get products, currency, and addToCart function from context
  ...
  // Function to find and set product data based on ID
      ...
      <div className='flex gap-12 sm:gap-12 flex-col sm:flex-row'>
        ...
        <div className='flex-1'>
          ...
          <div className='flex items-center gap-1 mt-2'>
            ...
            <img src={star} alt="star" className="w-3.5" />
            <img src={star} alt="star" className="w-3.5" />
            <img src={star_dull} alt="star" className="w-3.5" />
